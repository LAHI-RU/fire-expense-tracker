...
export default function ClientLayoutShell({
  ...
  return (
    <>
      ...
      {!hideNavAndFooter && (
        <footer className="w-full py-4 bg-gradient-to-r from-blue-900 via-indigo-800 to-indigo-900 text-center text-base text-white/80 font-semibold shadow-inner border-t border-blue-800 flex items-center justify-between px-6">
