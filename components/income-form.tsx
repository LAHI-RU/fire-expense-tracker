...
export function IncomeForm({ income, onSubmit, onCancel, isLoading }: IncomeFormProps) {
  const [formData, setFormData] = useState({
    ...
    payment_date: income?.payment_date ? new Date(income.payment_date).toISOString().split("T")[0] : "",
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="text-xl font-semibold">{income ? "Edit Income" : "Add New Income"}</CardTitle>
